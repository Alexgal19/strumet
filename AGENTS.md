...
- **Ollama Delegation:** Delegate all code-writing, code-editing, unit testing, TypeScript typings, documentation (JSDoc), and boilerplate refactoring tasks to the local Ollama model (`gemma4:12b`).
...
**Rules:**
- Delegate all actual code generation, testing (Vitest), TypeScript interfaces, JSDoc creation, and routine UI component refactoring to the local Ollama model (`gemma4:12b`).
