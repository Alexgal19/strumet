    ...
    return (
        <SidebarProvider>
            <div className="flex h-full flex-col md:flex-row bg-transparent">
                ...
                <SidebarInset className="m-0 flex flex-1 flex-col min-w-0 md:m-2 md:p-4 sm:p-6 lg:p-8 pb-28 md:pb-8 md:rounded-lg bg-card/80 shadow-lg w-full backdrop-blur-lg shadow-inner-border">
