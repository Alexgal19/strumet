...
export default function ZwolnieniPage() {
  ...
  const terminatedEmployees = useMemo(
    () => allEmployees.filter((e) => e.status === "zwolniony"),
    [allEmployees],
  );
  ...
  const filteredEmployees = useMemo(() => {
    return terminatedEmployees
      .filter((employee) => {
        ...
        return searchTermMatch && departmentMatch && jobTitleMatch;
      })
  ...
  const jobTitleOptions: OptionType[] = useMemo(
  ...
  const onRestoreEmployee = async (
    employeeId: string,
    employeeFullName: string,
  ) => {
    await handleRestoreEmployee({ id: employeeId, fullName: employeeFullName });
  };
  ...
  const columns = useMemo<ColumnDef<Employee>[]>(
    () => [
      ...
      },
      {
        ...
        cell: ({ row }) =>
          formatDate(row.original.terminationDate, "yyyy-MM-dd"),
      },
            ...
            return (
              ...
              >
                <EmployeeCard
                  ...
                  onRestore={() =>
                    onRestoreEmployee(employee.id, employee.fullName)
                  }
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      Tej akcji nie można cofnąć. Spowoduje to przywrócenie
                      wszystkich zwolnionych pracowników do listy aktywnych.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
                    <AlertDialogCancel>Anuluj</AlertDialogCancel>
                    <AlertDialogAction
                      onClick={handleRestoreAllTerminatedEmployees}
                    >
                      Kontynuuj
                    </AlertDialogAction>
                  </AlertDialogFooter>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      ...
                      wszystkich pracowników (aktywnych i zwolnionych) z bazy
                      danych.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      Tej akcji nie można cofnąć. Pracownik zostanie przywrócony
                      do listy aktywnych.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
