...
function AppContent({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="relative flex h-full flex-col md:flex-row bg-transparent overflow-hidden">
      ...
      <div className="fixed top-[-10%] left-[-10%] w-[40%] h-[40%] bg-primary/20 rounded-full blur-[120px] animate-pulse pointer-events-none z-[-1]" />
      <div className="fixed bottom-[-10%] right-[-10%] w-[30%] h-[30%] bg-blue-500/20 rounded-full blur-[100px] animate-pulse delay-1000 pointer-events-none z-[-1]" />
  ...
  return (
    <html lang="pl" className="dark" suppressHydrationWarning>
      <head>
        ...
        <link
          rel="stylesheet"
          href="https://cdn.jsdelivr.net/font-geist/latest/geist.css"
        />
