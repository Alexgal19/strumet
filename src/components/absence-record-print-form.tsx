      ...
      <div ref={ref} className="bg-white text-black font-sans">
        ...
        <div className="h-[25cm] flex flex-col justify-between p-4">
            <div>
                ...
                <div className="border-b-2 border-black py-2 px-2 mb-6 text-center">
                ...
                <div className="flex justify-between items-center border-b border-black py-5 mb-8 text-sm">
                    ...
                    <div className="flex items-baseline">
                        <span className="mr-2 text-gray-600">Stanowisko / Посада:</span>
                        <span className="font-semibold border-b border-dotted border-black px-2 min-w-[120px] inline-block text-center">{record.jobTitle}</span>
                    </div>
                </div>
                ...
                <div className="flex flex-wrap items-center border-b border-black py-5 gap-x-8 gap-y-3 mb-14 text-sm">
                    ...
                    <div className="flex items-baseline">
                        ...
                        <span className="font-bold text-base border-b border-dotted border-black min-w-[280px] inline-block text-center px-4">{record.hours || '________________'}</span>
                    </div>
                </div>

                <section className="space-y-14 mb-10">
